    ...
    if(Yii::$app->session->get('username') == 'guest' || Yii::$app->session->get('username') == '' ){
        ...
        echo Nav::widget([
            ...
            'items' => [
                    ...
                    ['label' => 'FlightLog', 'url' => ['/flightlog/index']], 
                    ['label' => 'Engineer', 'url' => ['/engineer/index']],
                    ['label' => 'Service', 'url' => ['/maintenance/index']],   
                    '<li>'
...
<main role="main" class="flex-shrink-0">
    <div class="container" class="imagebg">
        <?= Breadcrumbs::widget([
...
<footer class="footer mt-auto py-3 text-muted">
    <div class="container">
        <p class="float-left">&copy; ABC-Air <?= date('Y') ?></p>
